...
class RuntimeBindingTests(unittest.TestCase):
    ...
    def test_candidate_is_compiled_and_resolved_without_becoming_verified(self) -> None:
        ...
        self.assertEqual(plan.search_request["execution_contract"]["candidate_specific"], True)
        self.assertEqual(plan.search_request["execution_contract"]["fresh_state_per_stage"], True)
        self.assertEqual(plan.search_request["runtime"]["runtime_hash"], case.runtime.runtime_hash)
