"""Harness test executing a pinned-container EVM workflow for axelar_gmp (Axelar GMP)."""
...
def test_axelar_gmp_normal_workflow():
    harness_dir = Path(__file__).resolve().parent
    contract_test = "AxelarGMPPairedHarnessTest"
    ret, stdout, stderr = run_forge_test(harness_dir, contract_test)
    assert ret == 0, f"Foundry fixture harness failed for axelar_gmp:\n{stderr}\n{stdout}"
...
if __name__ == "__main__":
    test_axelar_gmp_normal_workflow()
