"""Harness test executing a pinned-container EVM workflow for layerzero_v2 (LayerZero v2)."""
...
def test_layerzero_v2_normal_workflow():
    harness_dir = Path(__file__).resolve().parent
    contract_test = "LayerZeroV2PairedHarnessTest"
    ret, stdout, stderr = run_forge_test(harness_dir, contract_test)
    assert ret == 0, f"Foundry fixture harness failed for layerzero_v2:\n{stderr}\n{stdout}"
...
if __name__ == "__main__":
    test_layerzero_v2_normal_workflow()
