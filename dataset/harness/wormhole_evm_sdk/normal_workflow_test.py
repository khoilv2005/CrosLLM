"""Harness test executing a pinned-container EVM workflow for wormhole_evm_sdk (Wormhole)."""
...
def test_wormhole_evm_sdk_normal_workflow():
    harness_dir = Path(__file__).resolve().parent
    contract_test = "WormholePairedHarnessTest"
    ret, stdout, stderr = run_forge_test(harness_dir, contract_test)
    assert ret == 0, f"Foundry fixture harness failed for wormhole_evm_sdk:\n{stderr}\n{stdout}"
...
if __name__ == "__main__":
    test_wormhole_evm_sdk_normal_workflow()
